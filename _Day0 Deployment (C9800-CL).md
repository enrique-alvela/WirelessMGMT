...
Click on the existing WLAN, `wireless-22` __[05]__
...
S: 32 - 6 = /26 (4th, 64i)  
I:  
  - 10.22.11.0 255.255.255.192  
  - 10.22.11.64 255.255.255.192   

<br>

__NETWORK ADDRESS: `10.22.11.0 255.255.255.192`__  
...
conf t
 ...
 int vlan 11
  ...
  ip add 10.22.11.4 255.255.255.192
  ip ospf 1 area 0
  no shut
 !
 ip dhcp excluded-address 10.22.11.1 10.22.11.10
 ip dhcp pool SOC-GROUP
  network 10.22.11.0 255.255.255.192
  default-router 10.22.11.4
...
S: 32 - 5 = /27 (4th, 32i)  
I:  
  - 10.22.12.0 255.255.255.224  
  - 10.22.12.32 255.255.255.224  

<br>

__NETWORK ADDRESS: `10.22.12.0 255.255.255.224`__  
...
conf t
 ...
 int vlan 11
  ...
  ip add 10.22.12.4 255.255.255.224
  ip ospf 1 area 0
  no shut
 !
 ip dhcp excluded-address 10.22.12.1 10.22.12.10
 ip dhcp pool NOC-GROUP
  network 10.22.12.0 255.255.255.224
  default-router 10.22.12.4
